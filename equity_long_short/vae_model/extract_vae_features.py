...
def form_start_dates(start_date, end_date, series_length):
    dates = []
    period_td = timedelta(int(series_length * 7. / 5))
...
def extract_vae_features(start_date, end_date, series_length, returns_lookback, vae, ticker_files, fundamentals_file, out_dir):
    """
